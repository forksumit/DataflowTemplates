...
import com.google.cloud.teleport.v2.transforms.PublishOrderedMaxwellLikeDataChangeRecordsKVToPubSub;
...
/**
 * The {@link SpannerOrderedMaxwellLikeChangeStreamsToPubSub} pipeline streams ordered (grouped by
 * bucketized partition key by and ordered by commit timestamp) change stream record(s) and then
 * transforms to maxwell like schema and then further stores to pubsub topic in user specified
 * format. The sink data can be stored in a JSON Text.
 *
 * <p>Note: This template doesn't ensure ordering within a transaction.
 *
 * <p>Check out <a
 * href="https://github.com/GoogleCloudPlatform/DataflowTemplates/blob/main/v2/googlecloud-to-googlecloud/README_Spanner_Ordered_Maxwell_Like_Change_Streams_to_PubSub.md">README</a>
 * for instructions on how to use or modify this template.
 */
@Template(
    name = "Spanner_Ordered_Maxwell_Like_Change_Streams_to_PubSub",
    ...
    flexContainerName = "spanner-ordered-maxwell-like-changestreams-to-pubsub",
    documentation =
...
public class SpannerOrderedMaxwellLikeChangeStreamsToPubSub {
  private static final Logger LOG =
      LoggerFactory.getLogger(SpannerOrderedMaxwellLikeChangeStreamsToPubSub.class);
  ...
  public static PipelineResult run(SpannerOrderedChangeStreamsToPubSubOptions options) {
    ...
    pipeline
        ...
        .apply(
            "Publish to Pub/Sub",
            PublishOrderedMaxwellLikeDataChangeRecordsKVToPubSub.newBuilder()
